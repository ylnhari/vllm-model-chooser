...
//  'native' = hardware tensor cores; 'sw' = vLLM software path (Marlin/etc, no speedup).
//  Absent = unsupported.
// Sources: vLLM quantization "supported hardware" docs + Marlin FP4/FP8 fallback behaviour.
const GPU_QUANT_COMPAT = {
  'L4-24GB':    { BF16: 'native', FP8: 'native', INT8: 'sw', INT4: 'sw' },
  'A100-80GB':  { BF16: 'native', FP8: 'sw',     INT8: 'sw', INT4: 'sw', NVFP4: 'sw' },
  'H100-80GB':  { BF16: 'native', FP8: 'native', INT8: 'sw', INT4: 'sw', NVFP4: 'sw', MXFP4: 'sw' },
  'H200-141GB': { BF16: 'native', FP8: 'native', INT8: 'sw', INT4: 'sw', NVFP4: 'sw', MXFP4: 'sw' },
  'B100-192GB': { BF16: 'native', FP8: 'native', INT8: 'sw', INT4: 'sw', NVFP4: 'native', MXFP4: 'native', MXFP8: 'sw' },
  'B200-192GB': { BF16: 'native', FP8: 'native', INT8: 'sw', INT4: 'sw', NVFP4: 'native', MXFP4: 'native', MXFP8: 'sw' },
};
...
// weight-only vram, type, tested) are preserved across syncs. Last sync: ${new Date().toISOString().slice(0, 10)}.
//
...
async function main() {
  ...
  const changes = { context: [], variants: [], gpuFeasibilityRemoved: 0 };
